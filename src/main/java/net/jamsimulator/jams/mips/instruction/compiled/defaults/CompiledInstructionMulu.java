...
public class CompiledInstructionMulu extends CompiledRSOPInstruction {

	public CompiledInstructionMulu(int sourceRegister, int targetRegister, int destinationRegister,
	...
	public CompiledInstructionMulu(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
