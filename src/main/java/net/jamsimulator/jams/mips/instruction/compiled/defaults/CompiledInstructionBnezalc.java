...
public class CompiledInstructionBnezalc extends CompiledI16Instruction {

	public CompiledInstructionBnezalc(int targetRegister, int offset, Instruction origin, BasicInstruction basicOrigin) {
		super(InstructionBnezalc.OPERATION_CODE, 0, targetRegister, offset, origin, basicOrigin);
	}

	public CompiledInstructionBnezalc(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
