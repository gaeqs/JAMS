...
public class CompiledInstructionBgezalc extends CompiledI16Instruction {

	public CompiledInstructionBgezalc(int targetRegister, int offset, Instruction origin, BasicInstruction basicOrigin) {
		super(InstructionBgezalc.OPERATION_CODE, targetRegister, targetRegister, offset, origin, basicOrigin);
	}

	public CompiledInstructionBgezalc(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
