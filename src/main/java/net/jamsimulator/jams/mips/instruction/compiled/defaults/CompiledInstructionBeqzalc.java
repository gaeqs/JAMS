...
public class CompiledInstructionBeqzalc extends CompiledI16Instruction {

	public CompiledInstructionBeqzalc(int targetRegister, int offset, Instruction origin, BasicInstruction basicOrigin) {
		super(InstructionBeqzalc.OPERATION_CODE, 0, targetRegister, offset, origin, basicOrigin);
	}

	public CompiledInstructionBeqzalc(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
