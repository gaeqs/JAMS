...
public class CompiledInstructionMul extends CompiledRSOPInstruction {

	public CompiledInstructionMul(int sourceRegister, int targetRegister, int destinationRegister,
	...
	public CompiledInstructionMul(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
