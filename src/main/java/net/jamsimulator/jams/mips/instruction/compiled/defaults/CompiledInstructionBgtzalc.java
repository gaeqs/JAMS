...
public class CompiledInstructionBgtzalc extends CompiledI16Instruction {

	public CompiledInstructionBgtzalc(int targetRegister, int offset, Instruction origin, BasicInstruction basicOrigin) {
		super(InstructionBgtzalc.OPERATION_CODE, 0, targetRegister, offset, origin, basicOrigin);
	}

	public CompiledInstructionBgtzalc(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
