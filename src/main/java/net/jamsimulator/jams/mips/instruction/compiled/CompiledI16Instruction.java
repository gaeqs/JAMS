 ...
 */
public abstract class CompiledI16Instruction extends CompiledInstruction {
	 ...
	 */
	public CompiledI16Instruction(int value, Instruction origin, BasicInstruction basicOrigin) {
	 ...
	 * @param basicOrigin    the origin basic instruction.
	 */
	public CompiledI16Instruction(int operationCode, int sourceRegister, int targetRegister, int immediate, Instruction origin, BasicInstruction basicOrigin) {
