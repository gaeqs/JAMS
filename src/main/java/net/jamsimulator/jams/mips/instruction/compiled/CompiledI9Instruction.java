 ...
 */
public abstract class CompiledI9Instruction extends CompiledInstruction {
	 ...
	 */
	public CompiledI9Instruction(int value, Instruction origin, BasicInstruction basicOrigin) {
	 ...
	 * @param basicOrigin    the origin basic instruction.
	 */
	public CompiledI9Instruction(int operationCode, int baseRegister, int targetRegister, int offset, int functionCode, Instruction origin, BasicInstruction basicOrigin) {
