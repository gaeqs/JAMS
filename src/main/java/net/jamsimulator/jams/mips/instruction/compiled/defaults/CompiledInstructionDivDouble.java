...
public class CompiledInstructionDivDouble extends CompiledRFPUInstruction {

	public CompiledInstructionDivDouble(int targetRegister, int sourceRegister, int destinationRegister, Instruction origin, BasicInstruction basicOrigin) {
	...
	public CompiledInstructionDivDouble(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
