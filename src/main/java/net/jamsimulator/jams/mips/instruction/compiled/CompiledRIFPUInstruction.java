 ...
 */
public abstract class CompiledRIFPUInstruction extends CompiledInstruction {
	 ...
	 */
	public CompiledRIFPUInstruction(int value, Instruction origin, BasicInstruction basicOrigin) {
	 ...
	 * @param basicOrigin    the origin basic instruction.
	 */
	public CompiledRIFPUInstruction(int operationCode, int subcode, int targetRegister, int sourceRegister,
