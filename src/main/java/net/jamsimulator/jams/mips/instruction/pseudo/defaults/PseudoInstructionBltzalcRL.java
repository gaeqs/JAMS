...
public class PseudoInstructionBltzalcRL extends PseudoInstruction {

	public static final String NAME = InstructionBltzalc.NAME;
	public static final String MNEMONIC = InstructionBltzalc.MNEMONIC;
	...
	public PseudoInstructionBltzalcRL() {
	...
	public AssembledInstruction[] assemble(InstructionSet set, int address, ParameterParseResult[] parameters) {
		...
		if (!(basic instanceof BasicInstruction))
			throw new AssemblerException("Basic instruction '" + InstructionBltzalc.MNEMONIC + "' not found.");
