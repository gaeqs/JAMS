...
public class CompiledInstructionSubDouble extends CompiledRFPUInstruction {

	public CompiledInstructionSubDouble(int targetRegister, int sourceRegister, int destinationRegister, Instruction origin, BasicInstruction basicOrigin) {
	...
	public CompiledInstructionSubDouble(int instructionCode, Instruction origin, BasicInstruction basicOrigin) {
