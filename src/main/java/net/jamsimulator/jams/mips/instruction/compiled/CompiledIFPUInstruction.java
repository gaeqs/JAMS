 ...
 */
public abstract class CompiledIFPUInstruction extends CompiledInstruction {
	 ...
	 */
	public CompiledIFPUInstruction(int value, Instruction origin, BasicInstruction basicOrigin) {
	 ...
	 * @param basicOrigin    the origin basic instruction.
	 */
	public CompiledIFPUInstruction(int operationCode, int baseRegister, int targetRegister, int immediate, Instruction origin, BasicInstruction basicOrigin) {
