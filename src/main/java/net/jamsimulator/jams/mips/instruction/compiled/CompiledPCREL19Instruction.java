 ...
 */
public abstract class CompiledPCREL19Instruction extends CompiledInstruction {
	 ...
	 */
	public CompiledPCREL19Instruction(int value, Instruction origin, BasicInstruction basicOrigin) {
	 ...
	 * @param basicOrigin    the origin basic instruction.
	 */
	public CompiledPCREL19Instruction(int operationCode, int sourceRegister, int pcrel, int immediate, Instruction origin, BasicInstruction basicOrigin) {
