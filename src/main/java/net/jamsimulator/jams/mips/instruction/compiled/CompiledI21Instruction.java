 ...
 */
public abstract class CompiledI21Instruction extends CompiledInstruction {
	 ...
	 */
	public CompiledI21Instruction(int value, Instruction origin, BasicInstruction basicOrigin) {
	 ...
	 * @param basicOrigin         the origin basic instruction.
	 */
	public CompiledI21Instruction(int operationCode, int destinationRegister, int immediate, Instruction origin, BasicInstruction basicOrigin) {
