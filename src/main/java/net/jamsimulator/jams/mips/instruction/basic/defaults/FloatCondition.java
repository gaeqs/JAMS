...
public enum FloatCondition {
	...
	SAF(0b00000, "Signaling always false"),
	SUN(0b00001, "Signalling unordered"),
	SEQ(0b00010, "Ordered signalling equal"),
	SUEQ(0b00011, "Signalling unordered or equal"),
	SLT(0b00100, "Ordered signalling less than"),
	SULT(0b00101, "Signalling unordered or less than"),
	SLE(0b00110, "Ordered signalling less than or equal"),
	SULE(0b00111, "Signalling unordered or less than or equal"),
