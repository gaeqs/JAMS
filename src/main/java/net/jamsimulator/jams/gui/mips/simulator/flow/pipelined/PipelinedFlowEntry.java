...
public class PipelinedFlowEntry extends FlowEntry {
	...
	public PipelinedFlowEntry(int index, ScrollPane scrollPane, FlowTable table, AssembledInstruction instruction, String registerStart, long instructionNumber, long startingCycle) {
