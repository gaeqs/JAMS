...
public class ParameterMatcherUnsigned16BitRegisterShift implements Predicate<String> {
	...
	public boolean test(String s) {
		...
		//Checks the number
		return ParameterType.UNSIGNED_16_BIT.match(s.substring(0, parenthesisIndex));
	}
}
