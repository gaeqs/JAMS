...
public class ParameterMatcherLabelSigned32BitShift implements Predicate<String> {
	...
	public boolean test(String s) {
		...
		return ParameterType.LABEL.match(label) && ParameterType.SIGNED_32_BIT
				.match(s.substring(plusIndex + 1, s.length() - 1));
	}
}
